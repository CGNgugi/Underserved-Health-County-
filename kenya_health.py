...
if page == "Overview":
    ...
    with right:
        ...
        finding("<b>Core result:</b> The two-cluster solution separates structurally underserved counties from moderately served counties.", COLORS["orange"])
...
# ─────────────────────────────────────────────────────────────
    ...
    with right:
        ...
        if raw is not None:
            ...
            finding("The output supports county assessment and prioritisation.", COLORS["blue"])
        panel_close()
